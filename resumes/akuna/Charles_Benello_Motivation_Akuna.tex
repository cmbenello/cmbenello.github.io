...
On the systems side: my paper CrocSort (VLDB 2026, co-first-author) builds a parallel external merge sort in Rust that completes within memory budgets where PostgreSQL, DuckDB, and ClickHouse abort. I sole-authored a follow-up at HPTS 2026 on sort configuration for cloud and disaggregated hardware. At EPFL last summer I cut out-of-memory query times by 50 to 200\% with a CUDA decompression strategy.
